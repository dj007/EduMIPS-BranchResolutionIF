...
public class GUIStatistics extends GUIComponent {
    ...
    StatPanel statPanel;
    JScrollPane jsp;
    private int nCycles, nInstructions, rawStalls, codeSize, WAWStalls, dividerStalls, memoryStalls, branchTaken, branchNotTaken, branchMiss; //Amjad
    private float cpi;
    ...
    class StatPanel extends JPanel {
        ...
        String[] statistics = {" Execution", " 0 Cycles", " 0 Instructions", " ", " Stalls", " 0 RAW Stalls", " 0 WAW Stalls",
            " 0 WAR Stalls", " 0 Structural Stalls(Divider not available)", "0 Branch Not Taken", " 0 Branch Taken Stalls", " 0 Branch Misprediction Stalls",
    ...
    public void update() {
        ...
        branchTaken = cpu.getBranchTaken();
        branchNotTaken = cpu.getBranchNotTaken();
        branchMiss = cpu.getBranchMiss();
    ...
    class MyListCellRenderer implements ListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            switch (index) {
                ...
                case 9: //AMJAD
                    if (branchNotTaken != 1) {
                        label.setText(" " + branchNotTaken + " " + CurrentLocale.getString("BNTS"));
                    } else {
                        label.setText(" " + branchNotTaken + " " + CurrentLocale.getString("BNTS"));
                    }
                    label.setFont(f);
                ...
                case 10: //Amjad
                    if (branchTaken != 1) {
                        label.setText(" " + branchTaken + " " + CurrentLocale.getString("BTS"));
                    } else {
                        label.setText(" " + branchTaken + " " + CurrentLocale.getString("BTS"));
                    }
                    label.setFont(f);
                ...
                case 11: //Amjad
                    if (branchMiss != 1) {
                        label.setText(" " + branchMiss + " " + CurrentLocale.getString("BMS"));
                    } else {
                        label.setText(" " + branchMiss + " " + CurrentLocale.getString("BMS"));
                    }
                    label.setFont(f);
